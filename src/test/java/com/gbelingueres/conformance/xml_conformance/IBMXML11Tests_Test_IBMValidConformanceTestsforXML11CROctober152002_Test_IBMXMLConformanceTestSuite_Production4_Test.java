 ...
 */
public class IBMXML11Tests_Test_IBMValidConformanceTestsforXML11CROctober152002_Test_IBMXMLConformanceTestSuite_Production4_Test {
  ...
  /**
   * Test ID: <pre>ibm-1-1-valid-P04-ibm04v01.xml</pre>
   * Test URI: <pre>valid/P04/ibm04v01.xml</pre>
  ...
  @Test
  public void testibm_1_1_valid_P04_ibm04v01xml() throws FileNotFoundException, IOException, XmlPullParserException {
    try(Reader reader = new FileReader(new File(testResourcesDir, "valid/P04/ibm04v01.xml"))) {
